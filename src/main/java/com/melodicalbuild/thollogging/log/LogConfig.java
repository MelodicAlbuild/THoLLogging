package com.melodicalbuild.thollogging.log;
...
public final class LogConfig {
    ...
    /**
     * Should not be instantiated. Use {@link com.melodicalbuild.thollogging.THoLLogging#getLogConfig()} instead.
     * @param pl the plugin instance
     * @param sender the sender
     */
    public LogConfig(@NotNull final THoLLogging pl, @NotNull final CommandSender sender) {
        // Is Citizens enabled?
