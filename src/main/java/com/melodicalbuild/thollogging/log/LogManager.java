...
public final class LogManager {
    private final THoLLogging pl;
    private final Map<File, List<String>> cache = new HashMap<>();
    private final Map<String, List<CommandSender>> live = new HashMap<>();
    private boolean debug = false;

    /**
     * Should not be instantiated. Use {@link THoLLogging#getLogManager()} instead.
     * @param pl the plugin instance
     * @param sender sender
     */
    public LogManager(@NotNull final THoLLogging pl, @NotNull final CommandSender sender) {
        this.pl = pl;
